...
bool Jogador:: batalhar(Monstro monstro1, string opcaoCenarioBatalha){
    ...
    if(elementoEscolhido == monstro1.fraqueza){
        ...
        if(this->vidas>1){
            ...
            cout << "Parece que esse elementar era mais do que voce podia lidar, infelizmente sua jornada de heroi acaba aqui!" << endl;//jogador morre se tiver apenas 1 vida
        }
...
void Jogador:: executarMorte(){
    ...
    cout << "O jogo acabou, voce perdeu! Suas vidas acabaram, aqui esta seu legado:" << endl;
    vidas = 0;
